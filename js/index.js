...
primero =  window.open("../ventanas/primera_ventana.html", "primero", "top=100, left=700, width=500, height=600");
segundo =  window.open("../ventanas/segunda_ventana.html", "primero", "top=100, left=700, width=500, height=600");
tercero =  window.open("../ventanas/tercera_ventana.html", "primero", "top=100, left=700, width=500, height=600");
}
